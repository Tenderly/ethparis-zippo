...
import (
	...
	"github.com/tenderly/solidity-hmr/ethereum/swarm/chunk"
)
...
//
// # go test -benchmem -run=none github.com/tenderly/solidity-hmr/ethereum/swarm/storage/localstore -bench BenchmarkRetrievalIndexes -v
// goos: darwin
// goarch: amd64
// pkg: github.com/tenderly/solidity-hmr/ethereum/swarm/storage/localstore
...
//
// go test -benchmem -run=none github.com/tenderly/solidity-hmr/ethereum/swarm/storage/localstore -bench BenchmarkUpload -v
// goos: darwin
// goarch: amd64
// pkg: github.com/tenderly/solidity-hmr/ethereum/swarm/storage/localstore
