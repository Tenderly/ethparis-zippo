...
Building Swarm requires Go (version 1.10 or later).
    ...
    go get -d github.com/tenderly/solidity-hmr/ethereum

    go install github.com/tenderly/solidity-hmr/ethereum/cmd/swarm
...
You must have your working copy under `$GOPATH/src/github.com/tenderly/solidity-hmr/ethereum`.
...
```
git clone git@github.com:nirname/go-ethereum.git $GOPATH/src/github.com/tenderly/solidity-hmr/ethereum
```
...
```
stateth --rm --grafana-dashboards-folder $GOPATH/src/github.com/tenderly/solidity-hmr/ethereum/swarm/grafana_dashboards --influxdb-database metrics
```
 ...
 * [Code review guidelines](https://github.com/tenderly/solidity-hmr/ethereum/wiki/Code-Review-Guidelines).
